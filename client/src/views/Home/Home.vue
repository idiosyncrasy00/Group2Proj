<template>
  ...
  <div>
    <div id="container">
			<div class = "d-flex flex-row justify-content-center mt-1 mx-auto" id="slider">
				...
				<div class="btn btn-next col-sm-1" aria-label="Next slide" @click="slide(1)">
					...
					<div class="bg-text">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ullamcorper, 
						felis et pulvinar volutpat, neque nulla viverra neque, id pellentesque nisl nulla ac quam.
						Vivamus eleifend tortor ac leo varius lobortis. Aliquam vitae dictum massa. 
						Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. 
						Etiam fermentum pharetra dictum. 
						Nam tristique, tortor non sollicitudin euismod, neque velit luctus felis, at venenatis neque tellus at lorem</p>
					</div>
