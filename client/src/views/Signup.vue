<template>
	<div class="container mx-auto my-auto mt-2" style="heigt: 70%; width: 80%; box-shadow: 0 30px 40px rgba(0,0,0,.4);">
		<div class="row text-center" style="padding:0;">
			<div class = "col-sm-4" style="background-color:#e0e0e0;padding:0;margin:0;">
				<img
						...
						<a class = "mx-auto" href="/signin" style="text-decoration:none;">Already have an account? Sign in now</a>
			</div>
			<div class = "col-sm-8" style="background-color:#b3ccff;padding:0;margin:0;">
